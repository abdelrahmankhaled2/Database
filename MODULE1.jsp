...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL STUDENTS.STUDENT_ID, STUDENTS.FIRST_NAME, 
STUDENTS.LAST_NAME, STUDENTS.GENDER, STUDENTS.FACULTY_NAME, STUDENTS.GRADE, 
STUDENTS.PHONE_NUMBER, STUDENTS.HIRE_DATE, STUDENTS.DEPARTMENT_ID
FROM STUDENTS ]]>
      </select>
      ...
      <group name="G_STUDENT_ID">
        ...
        <dataItem name="STUDENT_ID" oracleDatatype="number" columnOrder="11"
         ...
         columnFlags="33" defaultLabel="Student Id">
          <dataDescriptor expression="STUDENTS.STUDENT_ID"
        ...
        <dataItem name="FIRST_NAME" datatype="vchar2" columnOrder="12"
         ...
         columnFlags="33" defaultLabel="First Name">
          <dataDescriptor expression="STUDENTS.FIRST_NAME"
        ...
        <dataItem name="LAST_NAME" datatype="vchar2" columnOrder="13"
         ...
         columnFlags="33" defaultLabel="Last Name">
          <dataDescriptor expression="STUDENTS.LAST_NAME"
           descriptiveExpression="LAST_NAME" order="3" width="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="GENDER" datatype="vchar2" columnOrder="14" width="20"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Gender">
          <dataDescriptor expression="STUDENTS.GENDER"
           descriptiveExpression="GENDER" order="4" width="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="FACULTY_NAME" datatype="vchar2" columnOrder="15"
         width="30" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Faculty Name">
          <dataDescriptor expression="STUDENTS.FACULTY_NAME"
           descriptiveExpression="FACULTY_NAME" order="5" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="GRADE" datatype="vchar2" columnOrder="16" width="5"
         defaultWidth="50000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Grade">
          <dataDescriptor expression="STUDENTS.GRADE"
           descriptiveExpression="GRADE" order="6" width="5"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="PHONE_NUMBER" oracleDatatype="number" columnOrder="17"
         width="22" defaultWidth="90000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Phone Number">
          <dataDescriptor expression="STUDENTS.PHONE_NUMBER"
           descriptiveExpression="PHONE_NUMBER" order="7" width="22"
           precision="11"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="HIRE_DATE" datatype="date" oracleDatatype="date"
         ...
         columnFlags="33" defaultLabel="Hire Date">
          <dataDescriptor expression="STUDENTS.HIRE_DATE"
           descriptiveExpression="HIRE_DATE" order="8" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="DEPARTMENT_ID" oracleDatatype="number"
         columnOrder="19" width="22" defaultWidth="120000"
         defaultHeight="10000" columnFlags="33" defaultLabel="Department Id">
          <dataDescriptor expression="STUDENTS.DEPARTMENT_ID"
           descriptiveExpression="DEPARTMENT_ID" order="9" width="22"
           precision="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    ...
    <summary name="MaxGRADEPerReport" source="GRADE" function="maximum"
     width="5" reset="report" compute="report" defaultWidth="50000"
     defaultHeight="10000" columnFlags="552" defaultLabel="Maximum:">
      <displayInfo x="0.00000" y="0.00000" width="0.00000" height="0.00000"/>
    </summary>
    <summary name="CountDEPARTMENT_IDPerReport" source="DEPARTMENT_ID"
     function="count" precision="8" reset="report" compute="report"
     defaultWidth="100000" defaultHeight="10000" columnFlags="552"
     defaultLabel="Count:">
      <displayInfo x="0.00000" y="0.00000" width="0.00000" height="0.00000"/>
      ...
      <frame name="M_G_STUDENT_ID_GRPFR">
        ...
        <repeatingFrame name="R_G_STUDENT_ID" source="G_STUDENT_ID"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_FIRST_NAME" source="FIRST_NAME" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="1.25000" y="0.18750" width="0.56250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          ...
          <field name="F_GENDER" source="GENDER" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="2.37500" y="0.18750" width="0.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_FACULTY_NAME" source="FACULTY_NAME" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="2.87500" y="0.18750" width="0.68750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          ...
          <field name="F_PHONE_NUMBER" source="PHONE_NUMBER" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="3.87500" y="0.18750" width="0.93750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_HIRE_DATE" source="HIRE_DATE" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="4.81250" y="0.18750" width="0.93750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_DEPARTMENT_ID" source="DEPARTMENT_ID"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="5.75000" y="0.18750" width="1.25000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_STUDENT_ID_FTR">
          ...
          <field name="F_CountSTUDENT_IDPerReport"
           ...
           alignment="start">
            ...
            <geometryInfo x="0.00000" y="0.56250" width="1.25000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_MaxGRADEPerReport" source="MaxGRADEPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="7" bold="yes"/>
            <geometryInfo x="3.56250" y="0.37500" width="0.31250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
            <visualSettings fillPattern="transparent"
             fillBackgroundColor="Totals"/>
          </field>
          <field name="F_CountDEPARTMENT_IDPerReport"
           source="CountDEPARTMENT_IDPerReport" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="7" bold="yes"/>
            <geometryInfo x="5.75000" y="0.56250" width="1.25000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        ...
        <frame name="M_G_STUDENT_ID_HDR">
          ...
          <text name="B_STUDENT_ID" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.00000" y="0.00000" width="1.25000"
             height="0.18750"/>
          ...
          <text name="B_GENDER" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="2.37500" y="0.00000" width="0.50000"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes"
          ...
          <text name="B_FACULTY_NAME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="2.87500" y="0.00000" width="0.68750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes"
          ...
          <text name="B_PHONE_NUMBER" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.87500" y="0.00000" width="0.93750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes"
          ...
          <text name="B_HIRE_DATE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="4.81250" y="0.00000" width="0.93750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes"
          ...
          <text name="B_DEPARTMENT_ID" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="5.75000" y="0.00000" width="1.25000"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes"
...
<rw:dataArea id="MGSTUDENTIDGRPFR125">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBSTUDENTID125" asArray="no"/> class="OraColumnHeader"> Student Id </th>
   <th <rw:id id="HBFIRSTNAME125" asArray="no"/> class="OraColumnHeader"> First Name </th>
   <th <rw:id id="HBLASTNAME125" asArray="no"/> class="OraColumnHeader"> Last Name </th>
   <th <rw:id id="HBGENDER125" asArray="no"/> class="OraColumnHeader"> Gender </th>
   <th <rw:id id="HBFACULTYNAME125" asArray="no"/> class="OraColumnHeader"> Faculty Name </th>
   <th <rw:id id="HBGRADE125" asArray="no"/> class="OraColumnHeader"> Grade </th>
   <th <rw:id id="HBPHONENUMBER125" asArray="no"/> class="OraColumnHeader"> Phone Number </th>
   <th <rw:id id="HBHIREDATE125" asArray="no"/> class="OraColumnHeader"> Hire Date </th>
   <th <rw:id id="HBDEPARTMENTID125" asArray="no"/> class="OraColumnHeader"> Department Id </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGSTUDENTID1251" src="G_STUDENT_ID">
   <tr>
    <td <rw:headers id="HFSTUDENTID125" src="HBSTUDENTID125"/> class="OraCellNumber"><rw:field id="FSTUDENTID125" src="STUDENT_ID" nullValue="&nbsp;"> F_STUDENT_ID </rw:field></td>
    <td <rw:headers id="HFFIRSTNAME125" src="HBFIRSTNAME125"/> class="OraCellText"><rw:field id="FFIRSTNAME125" src="FIRST_NAME" nullValue="&nbsp;"> F_FIRST_NAME </rw:field></td>
    <td <rw:headers id="HFLASTNAME125" src="HBLASTNAME125"/> class="OraCellText"><rw:field id="FLASTNAME125" src="LAST_NAME" nullValue="&nbsp;"> F_LAST_NAME </rw:field></td>
    <td <rw:headers id="HFGENDER125" src="HBGENDER125"/> class="OraCellText"><rw:field id="FGENDER125" src="GENDER" nullValue="&nbsp;"> F_GENDER </rw:field></td>
    <td <rw:headers id="HFFACULTYNAME125" src="HBFACULTYNAME125"/> class="OraCellText"><rw:field id="FFACULTYNAME125" src="FACULTY_NAME" nullValue="&nbsp;"> F_FACULTY_NAME </rw:field></td>
    <td <rw:headers id="HFGRADE125" src="HBGRADE125"/> class="OraCellText"><rw:field id="FGRADE125" src="GRADE" nullValue="&nbsp;"> F_GRADE </rw:field></td>
    <td <rw:headers id="HFPHONENUMBER125" src="HBPHONENUMBER125"/> class="OraCellNumber"><rw:field id="FPHONENUMBER125" src="PHONE_NUMBER" nullValue="&nbsp;"> F_PHONE_NUMBER </rw:field></td>
    <td <rw:headers id="HFHIREDATE125" src="HBHIREDATE125"/> class="OraCellText"><rw:field id="FHIREDATE125" src="HIRE_DATE" nullValue="&nbsp;"> F_HIRE_DATE </rw:field></td>
    <td <rw:headers id="HFDEPARTMENTID125" src="HBDEPARTMENTID125"/> class="OraCellNumber"><rw:field id="FDEPARTMENTID125" src="DEPARTMENT_ID" nullValue="&nbsp;"> F_DEPARTMENT_ID </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
 ...
 <tr>
  ...
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFMaxGRADEPerReport125" src="HBGRADE125"/> class="OraTotalNumber">Maximum: <rw:field id="FMaxGRADEPerReport125" src="MaxGRADEPerReport" nullValue="&nbsp;"> F_MaxGRADEPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
 </tr>
 <tr>
  <td <rw:headers id="HFCountSTUDENTIDPerReport125" src="HBSTUDENTID125"/> class="OraTotalNumber">Count: <rw:field id="FCountSTUDENTIDPerReport125" src="CountSTUDENT_IDPerReport" nullValue="&nbsp;"> F_CountSTUDENT_IDPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  ...
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFCountDEPARTMENTIDPerReport125" src="HBDEPARTMENTID125"/> class="OraTotalNumber">Count: <rw:field id="FCountDEPARTMENTIDPerReport125" src="CountDEPARTMENT_IDPerReport" nullValue="&nbsp;"> F_CountDEPARTMENT_IDPerReport </rw:field></td>
 </tr>
</table>
</rw:dataArea> <!-- id="MGSTUDENTIDGRPFR125" -->
